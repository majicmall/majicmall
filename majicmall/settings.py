...
# Feature flags
# ==============================================================================
# Auto-publish storefronts in dev (only has effect if you wire it into your model logic)
...
# Treat site as HTTPS in prod if PUBLIC_BASE_URL is https
IS_HTTPS_SITE = PUBLIC_BASE_URL.startswith("https://")

# Only force secure behaviors when NOT debugging locally
if IS_HTTPS_SITE and not DEBUG:
    ...
    # Harden common headers
    SECURE_CONTENT_TYPE_NOSNIFF = True
    SECURE_REFERRER_POLICY = "same-origin"

    # HSTS (best practice) — keep small by default; increase later once you're confident
    # Set DJANGO_HSTS_SECONDS=31536000 for 1 year once everything is stable.
...
# New-style allauth settings (preferred)
